...
import { Input, Select, Btn, Modal, Empty, StatusBadge, ProgressBar, TabBar, KPICard, WeatherIcon, Spinner, Badge } from "../../components"
import { TopBar } from "../../layout/TopBar"
import { SatelliteMap } from "./maps/SatelliteMap"
import { LocationPicker } from "./maps/LocationPicker"
import { fmt } from "../../utils/formatters"
import { downloadProjectPDF } from "../../utils/exporters"
import { AreaChart, Area, BarChart, Bar, LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, ComposedChart, PieChart, Pie, Cell } from "recharts"
import { ArrowLeft, Edit3, Download, Calendar, Clock, MapPin, DollarSign, TrendingUp, FileText, AlertTriangle, CheckCircle, Activity, Layers, Camera, Eye, X, Plus, Trash2, Users, UserPlus, ClipboardList, BarChart2, UserCheck, UserX, User, Truck, Wrench, CloudRain, AlertCircle, MoreVertical } from "lucide-react"
...
export const ProjectDetail = ({ projectId, user, userRole, projects, setProjects, reports, onBack, notifications, onMarkAllRead }) => {
